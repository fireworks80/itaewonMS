         ...
         */
         FP.reBuild = function(resizing){
            ...
            $(SECTION_SEL).each(function(){
                ...
                // 리사이즈 될때 section의 height 값 설정
                if(windowsHeight >= 1420){
                    windowsHeight = 1420;
                }
                ...
                $(this).css('height', windowsHeight - gnbSize + 'px');
...
var sectionIndex = activeSection.index(SECTION_SEL);
        ...
        */
        function styleSection(section, index){
            ...
            section.css('height', (windowsHeight - 59) + 'px');
